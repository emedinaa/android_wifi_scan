...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private Dao<WifiEntity, Integer> wifiDao = null;
    private RuntimeExceptionDao<WifiEntity, Integer> wifiRuntimeDao = null;
    ...
    //-------------------------------------------------------------------------------
    public Dao<WifiEntity, Integer> getWifiDao() throws SQLException
    {
        if ( wifiDao == null) {
             wifiDao = getDao(WifiEntity.class);
        }
        return  wifiDao;
    }

    public RuntimeExceptionDao<WifiEntity, Integer> getWifiDataDao() {
        if (wifiRuntimeDao == null) {
            wifiRuntimeDao = getRuntimeExceptionDao(WifiEntity.class);
        }
        return wifiRuntimeDao;
    }
